...
<main className="relative bg-background-dark text-white">
     ...
     <header className="relative z-50 bg-transparent">
          ...
          <div className="flex items-center space-x-4">
            <button 
              ...
              className="hidden md:inline-block 
                bg-primary-400 text-primary-50 font-bold 
                px-4 sm:px-6 py-2 
                rounded-full 
        ...
        {isMobileMenuOpen && (
          <div 
            className="md:hidden bg-background-dark/95 backdrop-blur-md border-t border-gray-800 animate-fadeIn"
            role="dialog"
            aria-modal="true"
          ...
          >
            <div className="container mx-auto px-4 py-6 flex flex-col space-y-4">
              <button 
                onClick={() => handleNavClick('hero')}
                onKeyDown={(e) => e.key === 'Enter' && handleNavClick('hero')}
                className={`py-3 text-left transition duration-300 ${
                  activeSection === 'hero' 
              ...
              <button 
                onClick={handleContactClick}
                onKeyDown={(e) => e.key === 'Enter' && handleContactClick()}
                className="mt-4 bg-primary-400 text-primary-50 font-bold px-6 py-3 rounded-full hover:bg-primary-600 transition duration-300 shadow-lg hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-primary-400 focus:ring-opacity-50"
                aria-label="Contact us"
              >
                Contact us
              </button>
     ...
     <div>
        ...
        <section id="why" aria-label="Why us section">
          <WhyUsSection />
        </section>
